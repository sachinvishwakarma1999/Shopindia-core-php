    ...
    while ($p= mysqli_fetch_array($result)){
        ...
        <div class="row thumbnail" >
            ...
            <div class="col-sm-3 col-md-3 ">
                   ...
                   <a href="Electronics.php" class="btn btn-primary btn btn-block">Get Information</a>
            </div>
    ...
    while ($p= mysqli_fetch_array($result)){
        ?> 
                <div class="col-sm-3 col-md-3 ">
                  <img src="<?php echo $p[1];?>"style="height: 20%;width: 100%"><hr>
                <input name="typename" value="<?php echo $p[2];?>"style="border:none" readonly>
                <a href="men.php" class="btn btn-primary btn btn-block">Get Information</a>
            </div>
              <?php
require './coonection.php';
...
if($n>0){
    while ($p= mysqli_fetch_array($result)){
        ?> 
                ...
                <img src="<?php echo $p[1];?>"style="height: 20%;width: 100%"><hr>
                <input name="typename" value="<?php echo $p[2];?>"style="border:none" readonly>
                <a href="women.php" class="btn btn-primary btn btn-block">Get Information</a>
            </div>
            <?php
require './coonection.php';
...
if($n>0){
    while ($p= mysqli_fetch_array($result)){
        ?> 
                ...
                <img src="<?php echo $p[1];?>"style="height: 20%;width: 100%"><hr>
                <input name="typename" value="<?php echo $p[2];?>"style="border:none" readonly>
                <a href="furniture.php" class="btn btn-primary btn btn-block">Get Information</a>
            </div>
