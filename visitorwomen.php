...
$query="SELECT * from product where type='womenwear' ";
             ...
             <input style="border: none;text-align: center;width: 100%" value="<?php echo $p[2];?>">
              ...
              <div class="col-sm-3 col-md-3" style="height: auto;text-align: center">
                  <h1 style="font-family: serif">Price </h1>
                   <?php  echo $p[5];?>
                  <a class="btn btn-block" href="login.php?pid=<?php echo $p[0];?>"style="background-color: orange;color: white">Add Cart</a>
                  
                  <a class="btn btn-block" href="login.php?pid=<?php echo $p[0];?>"style="background-color: orangered;color: white">Buy</a>
              </div>
